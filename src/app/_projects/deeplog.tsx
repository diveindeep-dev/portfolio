...
import deeplogDark from '/public/assets/dark.png';
import deeplogLight from '/public/assets/light.png';
    ...
    <div>
      <SlideUp>
        <div className="modal-box sub">
          <h3>🎯 목표</h3>
          <div>꾸준히 쓰려고 만든 개인 개발 블로그</div>
        </div>
        <div className="modal-box sub">
          <h3>🛠️ Skills or Tools</h3>
          <div>
            Gatsby.js React ES2015+ GraphQL Styled-components Netlify Git MDX
          </div>
        </div>
        <div className="modal-box sub">
          <h3>💡 주요 특징</h3>
      ...
      <div className="project-content">
        ...
        <SlideUp>
          <div className="description">
            <div className="sub">다양한 개발 이야기를 하고 싶어서,</div>
            <span className="sub">꾸준히 쓰기위해 직접 만든,</span>
            <div>개인 개발 블로그</div>
          </div>
        </SlideUp>
        <div className="grid">
          ...
          <SlideUp>
            <div className="center">
              <div>
                <div className="block-title">Features</div>
                <div className="block-body sub">
                  <div>
                    정적 웹사이트, <span className="main">반응형 </span>
                    웹페이지,
                  </div>
                  <div>
                    <span className="main">라이트/다크 테마 </span>변경,
                  </div>
                  <div>MDX, GraphQL,</div>
                  <div>카테고리, 태그,</div>
                  <div>포스트 검색, 댓글(utterances),</div>
                  <span className="main">SEO</span>
                </div>
              </div>
            </div>
          </SlideUp>
